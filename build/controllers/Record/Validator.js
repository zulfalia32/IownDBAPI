...
var ValidationController = /** @class */ (function () {
    ...
    ValidationController.prototype.ValidateInputJson = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                //console.log("ValidateInputJson is here");
                if (req.body.RequestID == null || String(req.body.RequestID).trim() == "") {
                    res.json({ Status: "1", Message: "NoSuccess", Detail: "Please provide values in all attributes like RequestID, TenantID, Entity and Limit" });
