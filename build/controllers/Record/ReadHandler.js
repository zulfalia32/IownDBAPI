...
var ReadController = /** @class */ (function () {
    ...
    ReadController.prototype.Read = function (req, res, ModelName) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        query = _a.sent();
                        return [4 /*yield*/, ModelName.findAndCountAll({ limit: Number(req.body.Limit), where: JSON.parse(query) })
...
;
var ReadHandler = new ReadController();
