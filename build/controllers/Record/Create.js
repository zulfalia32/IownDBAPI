...
var MainController = /** @class */ (function () {
    ...
    MainController.prototype.createData = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, helper.ValidateInputJson(req, res, 'INSERT')];
                    case 1:
                    ...
                    case 2:
                        error_1 = _a.sent();
                        sendMessage(req, res, "IN4MA", "2", "Error message from create.ts:createData():" + error_1.message);
                        return [3 /*break*/, 3];
                    case 3:
                        ;
                        return [2 /*return*/];
...
;
var createData = new MainController();
