...
var CreateController = /** @class */ (function () {
    ...
    CreateController.prototype.Create = function (req, res, ModelName) {
        return __awaiter(this, void 0, void 0, function () {
            var query, countOfRowsInserted;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, helper.GetQueryString(req, res)];
                    case 1:
                        query = _a.sent();
                        return [4 /*yield*/, ModelName.create(JSON.parse(query))
                                .then(function (countOfRowsInserted) {
...
;
var CreateHandler = new CreateController();
